...
import { Bar, BarChart, Label, Pie, PieChart, Tooltip } from 'recharts'
        ...
        <div className='grid gap-6 lg:grid-cols-5'>
          <div className='flex flex-col gap-7 lg:col-span-3'>
            ...
            <div className='flex items-center gap-3'>
              <div className='size-10.5 rounded-lg bg-linear-to-br from-blue-400 to-blue-600'></div>
              <div className='flex flex-col gap-0.5'>
                <span className='text-xl font-medium'>Admin Dashboard</span>
                <span className='text-muted-foreground text-sm'>admin@company.com</span>
              </div>
            </div>
          ...
          <CardContent className='grid gap-4 px-4 lg:grid-cols-5'>
            ...
            <div className='flex flex-col gap-6 text-lg md:col-span-4'>
              ...
              <span className='text-muted-foreground text-wrap'>
                Analyzes key business metrics and performance indicators over a certain period.
              </span>
